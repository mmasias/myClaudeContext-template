...
# projects: debe ser directorio real (no symlink) en macOS
if [ -L ~/.claude/projects ]; then
    rm ~/.claude/projects
    echo "Eliminado symlink ~/.claude/projects"
elif [ -d ~/.claude/projects ]; then
    rm -rf ~/.claude/projects
    echo "Eliminado ~/.claude/projects (directorio real)"
fi
mkdir -p ~/.claude/projects
echo "Creado ~/.claude/projects como directorio real"
